...
file_name = "data/gpt2-small-124M.pth"
...
print(input_batch.shape, target_batch.shape, target_batch.dtype)
...
generate_and_print_sample(
    model, tokenizer, device, start_context=format_input(val_data[0]), max_new_tokens=20
)
